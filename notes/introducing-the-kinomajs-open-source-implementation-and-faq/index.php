...
<title>Introducing the KinomaJS Open Source Implementation - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("introducing-the-kinomajs-open-source-implementation.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Introducing the KinomaJS Open Source Implementation
        </div>    
        <div class="row">
            <!--Main Content -->
