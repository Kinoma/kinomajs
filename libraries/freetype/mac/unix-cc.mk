...
CFLAGS   := $(C_FLAGS) -c  -O2  -DFT_CONFIG_CONFIG_H="<ftconfig.h>" -I$(F_HOME)/libraries/freetype/src/freetype-2.5.0.1/include/freetype/config/ -arch i386 -w -Wno-multichar -Wmissing-prototypes -Wextra -isysroot /Developer/SDKs/MacOSX10.8.sdk
