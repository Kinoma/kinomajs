...
public:
    ...
    /*
     * Set/Get file format for volume calibration
     */
            void setFileFormat(vc_file_format format) { mAudioTrack->setFileFormat(format); }
            vc_file_format getFileFormat() { return mAudioTrack->getFileFormat(); }
#endif
