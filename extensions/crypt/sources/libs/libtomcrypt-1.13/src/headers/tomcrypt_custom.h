...
#if __FSK_LAYER__
#include "FskMemory.h"
#define XMALLOC	(void *)FskMemPtrAlloc
#define XREALLOC	(void *)FskMemPtrReallocC
#define XCALLOC(c,s)	(void *)FskMemPtrCalloc((c)*(s))
#define XFREE	FskMemPtrDispose
#define XMEMSET	FskMemSet
#define XMEMCPY	FskMemCopy
#define XMEMCMP	FskMemCompare
#endif
...
#define TIGER
#define SHA1
/*#define MD5*/	/* defined in fsk/core/network/md5.h */
#define MD4
#define MD2
#define RIPEMD128
#define RIPEMD160
