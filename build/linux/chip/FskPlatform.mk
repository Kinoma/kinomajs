...
<makefile>
	...
	<input name="$(CHIP_SYSROOT)/usr/include"/>
...
-->
	...
	<c option="-DDEVICE_NAME=C.H.I.P."/>

    <c option="--sysroot=$(CHIP_SYSROOT)"/>
	
	<library name="-Wl,-rpath,$(CHIP_SYSROOT)/usr/lib,-z,muldefs"/>
    <library name="-Wl,-rpath,.,-rpath,'$ORIGIN/lib'"/>
	<library name="-L$(CHIP_SYSROOT)/usr/lib"/>
