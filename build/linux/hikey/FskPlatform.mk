...
<makefile>
	...
	<input name="$(HIKEY_SYSROOT)/usr/include"/>
...
-->
	...
	<library name="-Wl,-rpath,$(HIKEY_SYSROOT)/usr/lib,-z,muldefs"/>
    <library name="-Wl,-rpath,.,-rpath,'$ORIGIN/lib'"/>
	<library name="-L$(HIKEY_SYSROOT)/usr/lib"/>
	<library name="-L$(HIKEY_SYSROOT)/usr/lib/aarch64-linux-gnu"/>
	<library name="-lm"/>
	<library name="-ldl"/>
	<library name="-lrt"/>
