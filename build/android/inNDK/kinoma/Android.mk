...
LOCAL_LDLIBS := -lEGL -lGLESv2 -ldl -llog -Wl,--allow-multiple-definition -Wl,--whole-archive $(F_HOME)/build/android/inNDK/Play/project/obj/local/armeabi/libfsk.a -Wl,--no-whole-archive
#LOCAL_LDLIBS := -lEGL -lGLESv2 -ldl -llog --whole-archive $(F_HOME)/build/android/inNDK/Play/project/obj/local/armeabi/libfsk.a
...
LOCAL_LDLIBS := -lEGL -lGLESv2 -ldl -llog -L$(F_HOME)/build/android/inNDK/Play/project/obj/local/armeabi/ -landroid

# LOCAL_LDLIBS := -lGLESv1_CM -ldl -lssl -lcrypto -L$(F_HOME)/build/android/inNDK/Play/project/obj/local/armeabi/ -landroid
