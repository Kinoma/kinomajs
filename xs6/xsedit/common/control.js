...
export class EffectSkin extends Skin {
	constructor(effects, dictionary) {
		var c = effects.length;
		var texture = dictionary.texture;
		...
		dictionary.texture = new Texture(port, srcScale);
		super(dictionary);
	}
}
