...
<!-- include [/Users/hoddie/Desktop/Element docs - Markdown/coap.md]{/Users/hoddie/Desktop/Element docs - Markdown/coap.md} -->
...
Initiates a CoAP request using the POST method with the payload as the message body.
	...
	let payload = ArrayBuffer.fromString("Hello POST");
...
* options - <!-- @@ description of using CoAP.Options here -->
...
<!-- end include [/Users/hoddie/Desktop/Element docs - Markdown/coap.md] -->
...
<!-- include [/Users/hoddie/Desktop/Element docs - Markdown/xm_wifi.md]{/Users/hoddie/Desktop/Element docs - Markdown/xm_wifi.md} -->
...
<!-- end include [/Users/hoddie/Desktop/Element docs - Markdown/xm_wifi.md] -->
...
<!-- include [/Users/hoddie/Desktop/Element docs - Markdown/crypt.md]{/Users/hoddie/Desktop/Element docs - Markdown/crypt.md} -->
...
The constructor of the Crypt.Digest class takes no parameters. Classes that extend Crypt.Digest may add their own parameters to the constructor.
	...
	let digest = new Crypt.Digest.MD5();
...
The key is an ArrayBuffer of either 16 or 32 bytes.
...
The decrypt function decodes the contents of the input ArrayBuffer. The results are put into the optional output ArrayBuffer, or returned in a new ArrayBuffer, when no output buffer is provided.
	...
	let result_B = new ArrayBuffer(16);
...
[RI] As we discussed, the padding bytes should be added to make the output multiple of the block size for CBC and ECB. No padding for CTR.
...
The value of the count parameter determines how many bytes of data are returned. The random bytes are returned in an ArrayBuffer.
...
[RI] for Crypt.BER, if we document it, I think encode and decode would be enough for now. encode takes an array of [tag, value], like [0x02, 1234], then outputs an ArrayBuffer in the DER format. (DER is the strict version of BER.) The result of encode will be a SEQUENCE if the array starts 0x30 or 0x31, like [0x30, [0x02, 1234], [0x01, true]]. decode does the reverse.
...
<!-- end include [/Users/hoddie/Desktop/Element docs - Markdown/crypt.md] -->
