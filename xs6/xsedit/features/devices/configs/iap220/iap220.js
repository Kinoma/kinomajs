...
export default class iap220 extends DeviceConfig {
	...
	get helperID() {
		return "xsedit.iap220.kinoma.marvell.com";
	}
	get helperProject() {
		return {
			id: this.helperID,
...
iap220.iconSkin = new Skin({ texture:new Texture("./icon.png", 1), x:0, y:0, width:60, height:60 });
iap220.id = "com.marvell.kinoma.launcher.iap220";
iap220.product = "Marvell IAP220";
iap220.tag = "iap220";
iap220.templateTag = "createSample";
iap220.url = this.uri;
