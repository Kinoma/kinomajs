...
export default class IntelEdison extends DeviceConfig {
	...
	get helperID() {
		return "xsedit.edison.kinoma.marvell.com";
	}
	get helperProject() {
		return {
			id: this.helperID,
...
IntelEdison.iconSkin = new Skin({ texture:new Texture("./icon.png", 1), x:0, y:0, width:60, height:60 });
IntelEdison.id = "com.marvell.kinoma.launcher.edison";
IntelEdison.product = "Intel Edison";
IntelEdison.tag = "Edison";
IntelEdison.templateTag = "createSample";
IntelEdison.url = this.uri;
