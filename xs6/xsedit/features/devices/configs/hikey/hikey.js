...
export default class hikey extends DeviceConfig {
	...
	get helperID() {
		return "xsedit.hikey.kinoma.marvell.com";
	}
	get helperProject() {
		return {
			id: this.helperID,
...
hikey.iconSkin = new Skin({ texture:new Texture("./icon.png", 1), x:0, y:0, width:60, height:60 });
hikey.id = "com.marvell.kinoma.launcher.hikey";
hikey.product = "LeMaker HiKey";
hikey.tag = "hikey";
hikey.templateTag = "createSample";
hikey.url = this.uri;
