...
export default class chip extends DeviceConfig {
	...
	get helperID() {
		return "xsedit.chip.kinoma.marvell.com";
	}
	get helperProject() {
		return {
			id: this.helperID,
...
chip.iconSkin = new Skin({ texture:new Texture("./icon.png", 1), x:0, y:0, width:60, height:60 });
chip.id = "com.marvell.kinoma.launcher.chip";
chip.product = "C.H.I.P.";
chip.tag = "chip";
chip.templateTag = "createSample";
chip.url = this.uri;
