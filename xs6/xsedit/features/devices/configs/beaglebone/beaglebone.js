...
export default class BeagleBone extends DeviceConfig {
	...
	get helperID() {
		return "xsedit.beaglebone.kinoma.marvell.com";
	}
	get helperProject() {
		return {
			id: this.helperID,
...
BeagleBone.iconSkin = new Skin({ texture:new Texture("./icon.png", 1), x:0, y:0, width:60, height:60 });
BeagleBone.id = "com.marvell.kinoma.launcher.beaglebone";
BeagleBone.product = "BeagleBone Black";
BeagleBone.tag = "BeagleBone";
BeagleBone.templateTag = "createSample";
BeagleBone.url = this.uri;
