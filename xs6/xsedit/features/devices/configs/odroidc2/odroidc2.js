...
export default class odroidc2 extends DeviceConfig {
	...
	get helperID() {
		return "xsedit.odroidc2.kinoma.marvell.com";
	}
	get helperProject() {
		return {
			id: this.helperID,
...
odroidc2.iconSkin = new Skin({ texture:new Texture("./icon.png", 1), x:0, y:0, width:60, height:60 });
odroidc2.id = "com.marvell.kinoma.launcher.odroidc2";
odroidc2.product = "ODroid C2";
odroidc2.tag = "odroidc2";
odroidc2.templateTag = "createSample";
odroidc2.url = this.uri;
