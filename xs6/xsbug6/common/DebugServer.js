export default class @ "KPR_debug" {
	...
	closeMachine(address) @ "KPR_debug_closeMachine"
	file(address, view, path, line) @ "KPR_debug_file"
	go(address) @ "KPR_debug_go"
	logout(address) @ "KPR_debug_logout"
	removeBreakpoint(address, path, line) @ "KPR_debug_removeBreakpoint"
	resetBreakpoints(address) @ "KPR_debug_resetBreakpoints"
	step(address) @ "KPR_debug_step"
	stepIn(address) @ "KPR_debug_stepIn"
	stepOut(address) @ "KPR_debug_stepOut"
