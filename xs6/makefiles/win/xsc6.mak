...
SRC_DIR = $(XS6)\sources
TMP_DIR_DBG = $(XS6)\tmp\win\debug\xsc6
TMP_DIR_RLS = $(XS6)\tmp\win\release\xsc6
...
release : $(TMP_DIR_RLS) $(BIN_DIR_RLS) $(BIN_DIR_RLS)\xsc6.exe
...
$(BIN_DIR_RLS)\xsc6.exe : $(OBJECTS_RLS)
	link \
		$(LINK_OPTIONS_RLS) \
		$(LIBRARIES) \
		$(OBJECTS_RLS) \
		/out:$(BIN_DIR_RLS)\xsc6.exe
...
debug : $(TMP_DIR_DBG) $(BIN_DIR_DBG) $(BIN_DIR_DBG)\xsc6.exe
...
$(BIN_DIR_DBG)\xsc6.exe : $(OBJECTS_DBG)
	link \
		$(LINK_OPTIONS_DBG) \
		$(LIBRARIES) \
		$(OBJECTS_DBG) \
		/out:$(BIN_DIR_DBG)\xsc6.exe
...
clean :
	del /Q $(BIN_DIR_DBG)\xsc6.exe
	del /Q $(TMP_DIR_DBG)
	del /Q $(BIN_DIR_RLS)\xsc6.exe
	del /Q $(TMP_DIR_RLS)
