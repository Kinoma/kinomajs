...
SRC_DIR = $(XS6)/sources
TMP_DIR_DBG = $(XS6)/tmp/mac/debug/xsrb6
TMP_DIR_RLS = $(XS6)/tmp/mac/release/xsrb6

C_OPTIONS = -fno-common $(MACOS_ARCH) $(MACOS_VERSION_MIN) -I$(INC_DIR) -I$(SRC_DIR) -DmxRun=1
ifneq ("x$(SDKROOT)", "x")
...
$(BIN_DIR_DBG)/xsrb6: $(OBJECTS_DBG)
	$(CC) $(LINK_OPTIONS_DBG) $(LIBRARIES) $(OBJECTS_DBG) -o $(BIN_DIR_DBG)/xsrb6
