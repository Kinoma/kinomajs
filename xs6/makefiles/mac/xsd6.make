...
SRC_DIR = $(XS6)/sources
TMP_DIR_DBG = $(XS6)/tmp/mac/debug/xsd6
TMP_DIR_RLS = $(XS6)/tmp/mac/release/xsd6

C_OPTIONS = -fno-common $(MACOS_ARCH) $(MACOS_VERSION_MIN) -I$(INC_DIR) -I$(SRC_DIR) -I$(SRC_DIR)/tool -DmxDecompile=1
ifneq ("x$(SDKROOT)", "x")
