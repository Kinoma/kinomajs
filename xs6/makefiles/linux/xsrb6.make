...
BIN_DIR_DBG = $(XS6)/bin/linux/debug
BIN_DIR_RLS = $(XS6)/bin/linux/release
INC_DIR = $(XS6)/includes
SRC_DIR = $(XS6)/sources
TMP_DIR_DBG = $(XS6)/tmp/linux/debug/xsrb6
TMP_DIR_RLS = $(XS6)/tmp/linux/release/xsrb6

C_OPTIONS = -fno-common -I$(INC_DIR) -I$(SRC_DIR) -DmxRun=1
ifneq ("x$(SDKROOT)", "x")
...
OBJECTS_DBG = \
	...
	$(TMP_DIR_DBG)/xs6ToolHost.o \
	$(TMP_DIR_DBG)/xs6ToolPlatform.o \
...
OBJECTS_RLS = \
	...
	$(TMP_DIR_RLS)/xs6ToolHost.o \
	$(TMP_DIR_RLS)/xs6ToolPlatform.o \
...
debug: $(TMP_DIR_DBG) $(BIN_DIR_DBG) $(BIN_DIR_DBG)/xsrb6
...
$(BIN_DIR_DBG)/xsrb6: $(OBJECTS_DBG)
	$(CC) $(LINK_OPTIONS_DBG) $(OBJECTS_DBG) $(LIBRARIES) -o $(BIN_DIR_DBG)/xsrb6
	
$(OBJECTS_DBG): $(SRC_DIR)/xs6Platform.h
...
release: $(TMP_DIR_RLS) $(BIN_DIR_RLS) $(BIN_DIR_RLS)/xsrb6
...
$(BIN_DIR_RLS)/xsrb6: $(OBJECTS_RLS)
	$(CC) $(LINK_OPTIONS_RLS) $(LIBRARIES) $(OBJECTS_RLS) -o $(BIN_DIR_RLS)/xsrb6

$(OBJECTS_RLS): $(SRC_DIR)/xs6Platform.h
...
clean:
	rm -f $(OBJECTS_DBG) $(BIN_DIR_DBG)/xsrb6
	rm -f $(OBJECTS_RLS) $(BIN_DIR_RLS)/xsrb6
