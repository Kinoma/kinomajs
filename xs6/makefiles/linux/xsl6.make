...
SRC_DIR = $(XS6)/sources
TMP_DIR_DBG = $(XS6)/tmp/linux/debug/xsl6
TMP_DIR_RLS = $(XS6)/tmp/linux/release/xsl6

C_OPTIONS = -fno-common -I$(INC_DIR) -I$(SRC_DIR) -I$(SRC_DIR)/tool -DmxLink=1
ifneq ("x$(SDKROOT)", "x")
...
debug: $(TMP_DIR_DBG) $(BIN_DIR_DBG) $(BIN_DIR_DBG)/xsl6
...
$(BIN_DIR_DBG)/xsl6: $(OBJECTS_DBG)
	$(CC) $(LINK_OPTIONS_DBG) $(LIBRARIES) $(OBJECTS_DBG) -o $(BIN_DIR_DBG)/xsl6
...
release: $(TMP_DIR_RLS) $(BIN_DIR_RLS) $(BIN_DIR_RLS)/xsl6
...
$(BIN_DIR_RLS)/xsl6: $(OBJECTS_RLS)
	$(CC) $(LINK_OPTIONS_RLS) $(LIBRARIES) $(OBJECTS_RLS) -o $(BIN_DIR_RLS)/xsl6
...
clean:
	rm -f $(BIN_DIR_DBG)/xsl6
	rm -f $(BIN_DIR_RLS)/xsl6
	rm -rf $(TMP_DIR_DBG)
	rm -rf $(TMP_DIR_RLS)
