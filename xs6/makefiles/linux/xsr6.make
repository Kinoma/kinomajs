...
SRC_DIR = $(XS6)/sources
TMP_DIR_DBG = $(XS6)/tmp/linux/debug/xsr6
TMP_DIR_RLS = $(XS6)/tmp/linux/release/xsr6

C_OPTIONS = -fno-common -I$(INC_DIR) -I$(SRC_DIR) -I$(SRC_DIR)/tool -DmxParse=1 -DmxRun=1 -fPIC
ifneq ("x$(SDKROOT)", "x")
...
$(BIN_DIR_DBG)/xsr6: $(OBJECTS_DBG) $(TMP_DIR_DBG)/xs6Host.o $(TMP_DIR_DBG)/xs6Platform.o
	$(CC) $(LINK_OPTIONS_DBG) $(OBJECTS_DBG) $(TMP_DIR_DBG)/xs6Host.o $(TMP_DIR_DBG)/xs6Platform.o $(LIBRARIES) -o $(BIN_DIR_DBG)/xsr6
...
$(BIN_DIR_RLS)/xsr6: $(OBJECTS_RLS) $(TMP_DIR_RLS)/xs6Host.o $(TMP_DIR_RLS)/xs6Platform.o
	$(CC) $(LINK_OPTIONS_RLS) $(OBJECTS_RLS) $(TMP_DIR_RLS)/xs6Host.o $(TMP_DIR_RLS)/xs6Platform.o $(LIBRARIES) -o $(BIN_DIR_RLS)/xsr6
