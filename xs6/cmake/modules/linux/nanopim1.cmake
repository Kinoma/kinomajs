...
set(CMAKE_SYSTEM_PROCESSOR "nanopim1")

set(TOOL_PREFIX arm-linux-gnueabihf-) 
set(NANOPIM1_SYSROOT $ENV{NANOPIM1_SYSROOT})

find_path(TOOLCHAIN_BIN ${TOOL_PREFIX}gcc $ENV{PATH} $ENV{NANOPIM1_GNUEABI}/bin)
...
set(AS_NEON_OPTIONS "-mfpu=neon" CACHE STRING "AS OPTIONS")
