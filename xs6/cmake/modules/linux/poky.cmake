...
set(CMAKE_SYSTEM_PROCESSOR "poky")

set(TOOL_PREFIX arm-poky-linux-gnueabi-)
set(FSK_SYSROOT_LIB $ENV{POKY_SYSROOT})

find_path(TOOLCHAIN_BIN ${TOOL_PREFIX}gcc $ENV{PATH} $ENV{POKY_SYSROOT}/usr/bin/arm-poky-linux-gnueabi)
...
set(AS_V7_OPTIONS )
set(AS_WMMX ${TOOLCHAIN_BIN}/${TOOL_PREFIX}as)
set(AS_WMMX_OPTIONS -mcpu=iwmmxt2)
