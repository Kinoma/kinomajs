...
extern FskInstrumentedTypeRecord gkinomapngdecippTypeInstrumentation;
#define dlog(...)  do { FskInstrumentedTypePrintfDebug  (&gkinomapngdecippTypeInstrumentation, __VA_ARGS__); } while(0)
#else
#define dlog(...)
#endif
