...
#include "FskPlatformImplementation.h"
    extern FskInstrumentedTypeRecord gkinomaaacippdecodeTypeInstrumentation;
    //FskInstrumentedSimpleType(kinomaaacippdecode, kinomaaacippdecode);
#define dlog(...)  do { FskInstrumentedTypePrintfDebug  (&gkinomaaacippdecodeTypeInstrumentation, __VA_ARGS__); } while(0)
#else
#define dlog(...)
#endif
