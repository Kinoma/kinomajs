...
<title>Application Logic in Behaviors - KinomaJS Tutorials</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("behaviors.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/docbreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?>  /  <a href="../">KinomaJS Tutorials</a> / Application Logic in Behaviors
        </div>
        <div class="row">
            <!--Main Content -->
