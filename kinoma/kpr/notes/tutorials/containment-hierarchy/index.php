...
<title>The KinomaJS Containment Hierarchy - KinomaJS Tutorials</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("containment-hierarchy.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/docbreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?>  /  <a href="../">KinomaJS Tutorials</a> / The KinomaJS Containment Hierarchy
        </div>
        <div class="row">
            <!--Main Content -->
