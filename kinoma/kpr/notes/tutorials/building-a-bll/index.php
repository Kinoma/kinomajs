...
<title>Building Your Own BLLs - KinomaJS Tutorials</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("building-a-bll.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/docbreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?>  /  <a href="../">KinomaJS Tutorials</a> / Building Your Own BLLs
        </div>
        <div class="row">
            <!--Main Content -->
