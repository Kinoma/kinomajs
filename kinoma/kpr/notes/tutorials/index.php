...
<title>KinomaJS Tutorials - Kinoma Documentation</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("kinomajs-tutorials.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/docbreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / KinomaJS Tutorials
        </div>
        <div class="row">
            <!--Main Content -->
