...
<title>Interacting with Web Services Asynchronously - KinomaJS Tutorials</title>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/docbreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?>  /  <a href="../">KinomaJS Tutorials</a> / Interacting with Web Services Asynchronously
        </div>
        <div class="row">
            <!--Main Content -->
