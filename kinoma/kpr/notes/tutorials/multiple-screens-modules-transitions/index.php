...
<title>Using Modules for Screens and Transitions - KinomaJS Tutorials</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("multiple-screens-modules-transitions.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/docbreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?>  /  <a href="../">KinomaJS Tutorials</a> / Using Modules for Screens and Transitions
        </div>
        <div class="row">
            <!--Main Content -->
