...
<title>Kinoma Documentation - KinomaJS Tutorials - Displaying Images and Media</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("images-media.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/docbreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?>  /  <a href="../">KinomaJS Tutorials</a> / Displaying Images and Media
        </div>
        <div class="row">
            <!--Main Content -->
