...
<title>Scrolling Content and Programmatically Adjusting Layout - KinomaJS Tutorials</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("advanced-layouts.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/docbreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?>  /  <a href="../">KinomaJS Tutorials</a> / Scrolling Content and Programmatically Adjusting Layout
        </div>
        <div class="row">
            <!--Main Content -->
