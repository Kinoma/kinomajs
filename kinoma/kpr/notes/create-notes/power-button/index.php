...
<title>Power Button - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("power-button.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Power Button
        </div>     
        <div class="row">
            <!--Main Content -->
