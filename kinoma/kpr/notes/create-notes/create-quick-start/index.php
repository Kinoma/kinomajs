...
<title>Kinoma Create Quick Start Guide - Kinoma Documentation</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("create-quick-start.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
    	<div class="breadCrumb">
            <?php $path = "/includes/docbreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Kinoma Create Quick Start Guide
        </div>
        <div class="row">
            <!--Main Content -->  
            <div class="word-docs col-lg-9 col-md-9 col-sm-12 col-xs-12">
