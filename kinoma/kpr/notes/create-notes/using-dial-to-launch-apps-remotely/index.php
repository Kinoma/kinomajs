...
<title>Using DIAL to Launch Apps Remotely - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("using-dial-to-launch-apps-remotely.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Using DIAL to Launch Apps Remotely
        </div>        
        <div class="row">
            <!--Main Content -->
