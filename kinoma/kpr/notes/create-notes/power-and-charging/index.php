...
<title>Power and Charging - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("power-and-charging.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Power and Charging
        </div>       
        <div class="row">
            <!--Main Content -->
