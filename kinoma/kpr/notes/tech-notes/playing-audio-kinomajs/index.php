...
<title>Playing Audio with KinomaJS - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("playing-audio-kinomajs.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Playing Audio with KinomaJS
        </div>       
        <div class="row">
            <!--Main Content -->
