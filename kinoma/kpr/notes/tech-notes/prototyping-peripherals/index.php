...
<title>Prototyping Peripherals with Kinoma Create - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("prototyping-peripherals.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Prototyping Peripherals with Kinoma Create
        </div>      
        <div class="row">
            <!--Main Content -->
