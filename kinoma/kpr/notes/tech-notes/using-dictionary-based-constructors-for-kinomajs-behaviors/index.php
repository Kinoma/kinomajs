...
<title>Using Dictionary-Based Constructors for KinomaJS Behaviors - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("using-dictionary-based-constructors-for-kinomajs-behaviors.md")
  		//fetcher: Flatdoc.github('Kinoma/SourceDocumentation','technotes/using-dictionary-based-constructors-for-kinomajs-behaviors.md')
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Using Dictionary-Based Constructors for KinomaJS Behaviors
        </div>      
        <div class="row">
            <!--Main Content -->
