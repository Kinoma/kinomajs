...
<title>Realtime Cross Device Communication with PubNub - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("pubnub.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
		<div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Realtime Cross Device Communication with PubNub
      	</div>
        <div class="row">
            <!--Main Content -->
