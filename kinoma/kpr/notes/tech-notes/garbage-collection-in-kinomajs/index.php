...
<title>Garbage Collection in KinomaJS - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("garbage-collection-in-kinomajs.md")
	});
</script>
<!-- Custom CSS for this page -->
<style type="text/css">
	.flatdocContentArea iframe{
		margin-bottom: 14px;
	}
</style>
</head>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Garbage Collection in KinomaJS
        </div>
        <div class="row">
            <!--Main Content -->
