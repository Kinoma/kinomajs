...
<title>Embedding an HTTP Server in Your Application - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("embedding-an-http-server-in-your-application.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Embedding an HTTP Server in Your Application
        </div>      
        <div class="row">
            <!--Main Content -->
...
<script src="/libs/scrollspy.js"></script>
</body>
</html>