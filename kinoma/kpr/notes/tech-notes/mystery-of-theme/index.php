...
<title>The Mystery of THEME - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("mystery-of-theme.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / The Mystery of THEME
        </div>    
        <div class="row">
            <!--Main Content -->
