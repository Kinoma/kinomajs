...
<title>Using Fractional Coordinates for Animation in KinomaJS - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("using-fractional-coordinates-for-animation-in-kinomajs.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Using Fractional Coordinates for Animation in KinomaJS
        </div>      
        <div class="row">
            <!--Main Content -->
