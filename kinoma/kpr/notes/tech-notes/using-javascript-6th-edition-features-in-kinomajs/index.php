...
<title>Using JavaScript 6th Edition Features in KinomaJS - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("using-javascript-6th-edition-features-in-kinomajs.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Using JavaScript 6th Edition Features in KinomaJS
        </div>       
        <div class="row">
            <!--Main Content -->
