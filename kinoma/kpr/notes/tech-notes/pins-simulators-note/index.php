...
<title>Pins Simulators - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("pins-simulators.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Pins Simulators
        </div>        
        <div class="row">
            <!--Main Content -->
