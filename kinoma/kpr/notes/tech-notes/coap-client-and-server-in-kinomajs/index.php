...
<title>CoAP Client and Server in KinomaJS - Tech Notes</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("coap-client-and-server-in-kinomajs.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / CoAP Client and Server in KinomaJS
        </div>
        <div class="row">
            <!--Main Content -->
