...
<title>Kinoma Studio Tech Notes - Troubleshooting Zeroconf</title>
...
<script>
	Flatdoc.run({
		fetcher: Flatdoc.file("zero-conf-troubleshooting.md")
	});
</script>
...
<section id="page-content">
    <div class="container">
        <div class="breadCrumb">
        	<?php $path = "/includes/technotebreadcrumb.php"; include_once($_SERVER['DOCUMENT_ROOT'] . $path); ?> / Troubleshooting Zeroconf
        </div>       
        <div class="row">
            <!--Main Content -->
