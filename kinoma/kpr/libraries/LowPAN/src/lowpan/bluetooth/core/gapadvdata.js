...
function serializeManufacturerSpecificData({identifier, data /* = null // FIXME: KINOMA STUDIO WILL CRASH!!  */}) {
	let buffer = ByteBuffer.allocateUint8Array(GAP.MAX_AD_LENGTH - 2, true);
...
const AdvertisingDataSerializer = {
	...
	["shortName"]: param => {
		return {
			...
			data: BTUtils.toCharArray(param)
		};
	},
	["completeName"]: param => {
		return {
