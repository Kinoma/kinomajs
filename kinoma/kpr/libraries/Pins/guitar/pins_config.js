...
{	
    ...
    var fixedPins = [
		{ pin: 29, type: "Power", voltage: 3.3 },
		{ pin: 30, type: "Power", voltage: 5 },
		{ pin: 2, type: "I2CData", sda: 3, bus: 1 },
		{ pin: 31, type: "Power", voltage: 5 },
		{ pin: 3, type: "I2CClock", clock: 5, bus: 1 },
		{ pin: 32, type: "Ground" },
		{ pin: 4, type: "Digital", direction: directions[7] },
		{ pin: 14, type: "UartTX" },
		{ pin: 33, type: "Ground" },
		{ pin: 15, type: "UartRX" },
		{ pin: 17, type: "Digital", direction: directions[11] },
		{ pin: 18, type: "Digital", direction: directions[12] },
		{ pin: 27, type: "Digital", direction: directions[13] },
		{ pin: 34, type: "Ground" },
		{ pin: 22, type: "Digital", direction: directions[15] },
		{ pin: 23, type: "Digital", direction: directions[16] },
		{ pin: 35, type: "Power", voltage: 3.3 },
		{ pin: 24, type: "Digital", direction: directions[18] },
		{ pin: 10, type: "Digital", direction: directions[19] },
		{ pin: 36, type: "Ground" },
		{ pin: 9, type: "Digital", direction: directions[21] },
		{ pin: 25, type: "Digital", direction: directions[22] },
		{ pin: 11, type: "Digital", direction: directions[23] },
		{ pin: 8, type: "Digital", direction: directions[24] },
		{ pin: 37, type: "Ground" },
		{ pin: 7, type: "Digital", direction: directions[26] },
		{ pin: 0, type: "Digital", direction: directions[27] },
		{ pin: 1, type: "Digital", direction: directions[28] },
		{ pin: 5, type: "Digital", direction: directions[29] },
		{ pin: 38, type: "Ground" },
		{ pin: 6, type: "Digital", direction: directions[31] },
		{ pin: 12, type: "Digital", direction: directions[32] },
		{ pin: 13, type: "Digital", direction: directions[33] },
		{ pin: 39, type: "Ground" },
		{ pin: 19, type: "Digital", direction: directions[35] },
		{ pin: 16, type: "Digital", direction: directions[36] },
		{ pin: 26, type: "Digital", direction: directions[37] },
		{ pin: 20, type: "Digital", direction: directions[38] },
		{ pin: 40, type: "Ground" },
		{ pin: 21, type: "Digital", direction: directions[40] },
	];
    return fixedPins;
}
