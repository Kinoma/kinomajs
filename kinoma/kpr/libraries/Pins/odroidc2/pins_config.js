...
function makeBackHeader(count)
{
	...
	header[6] = header[9] = header[14] =
	header[20] = header[25] = header[30] = 
	header[34] = header[39] = Pins.ground;
header[7] = header[28] = header[37] = header[40] = Pins.ground; //non-responding pins/analog

	header[1] = header[11] = Pins.power3_3V;
	header[38] = Pins.power3_3V;	// 1.8v ADC Ref voltage
...
{	
	...
	var fixedPins = [
		...
		{ pin: 205, type: "I2CData", bus: 1 },
		{ pin: 4, type: "Power", voltage: 5 },
		{ pin: 206, type: "I2CClock", bus: 1},
		{ pin: 6, type: "Ground" },
		{ pin: 7, type: "Ground" },	// 249 - doesn't work
		{ pin: 113, type: "UartTX" },
		{ pin: 9, type: "Ground" },
		{ pin: 114, type: "UartRX" },
		{ pin: 247, type: "Digital", direction: directions[11] },
		{ pin: 238, type: "Digital", direction: directions[12] },
		{ pin: 239, type: "Digital", direction: directions[13] },
		{ pin: 14, type: "Ground" },
		{ pin: 237, type: "Digital", direction: directions[15] },
		{ pin: 236, type: "Digital", direction: directions[16] },
		{ pin: 17, type: "Power", voltage: 3.3 },
		{ pin: 233, type: "Digital", direction: directions[18] },
		{ pin: 235, type: "Digital", direction: directions[19] },
		{ pin: 20, type: "Ground" },
		{ pin: 232, type: "Digital", direction: directions[21] },
		{ pin: 231, type: "Digital", direction: directions[22] },
		{ pin: 230, type: "Digital", direction: directions[23] },
		{ pin: 229, type: "Digital", direction: directions[24] },
		{ pin: 25, type: "Ground" },
		{ pin: 225, type: "Digital", direction: directions[26] },
		{ pin: 207, type: "Digital", direction: directions[27] },
		{ pin: 28, type: "Ground" },		// pin 77 gpio doesn't work
		{ pin: 228, type: "Digital", direction: directions[29] },
		{ pin: 30, type: "Ground" },
		{ pin: 219, type: "Digital", direction: directions[31] },
		{ pin: 224, type: "Digital", direction: directions[32] },
		{ pin: 234, type: "Digital", direction: directions[33] },
		{ pin: 34, type: "Ground" },
		{ pin: 214, type: "Digital", direction: directions[35] },
		{ pin: 218, type: "Digital", direction: directions[36] },
		{ pin: 37, type: "Ground" },	// Analog
		{ pin: 38, type: "Power", voltage: 3.3 },	// 1.8v
		{ pin: 39, type: "Ground" },
		{ pin: 40, type: "Ground" },	// Analog
	];
	return fixedPins;
}
