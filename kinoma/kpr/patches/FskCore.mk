...
<makefile>
	...
	<input name="$(F_HOME)/xs/sources/xslib"/>
	...
	<source name="xsAll.c"/>
	<source name="xsAPI.c"/>
	<source name="xsArray.c"/>
	<source name="xsBoolean.c"/>
	<source name="xsChunk.c"/>
	<source name="xsDate.c"/>
	<source name="xsDebug.c"/>
	<source name="xs_dtoa.c"/>
	<source name="xsError.c"/>
	<source name="xsFunction.c"/>
	<source name="xsGlobal.c"/>
	<source name="xsGrammar.c"/>
	<source name="xsInfoSet.c"/>
	<source name="xs_expat.c"/>
	<source name="xsMarshall.c"/>
	<source name="xsMath.c"/>
	<source name="xsMemory.c"/>
	<source name="xsNumber.c"/>
	<source name="xsObject.c"/>
	<source name="xs_pcre.c"/>
	<source name="xsPlatform.c"/>
	<source name="xsProfile.c"/>
	<source name="xsProperty.c"/>
	<source name="xsRegExp.c"/>
	<source name="xsRun.c"/>
	<source name="xsScript.c"/>
	<source name="xsString.c"/>
	<source name="xsSymbol.c"/>
	<source name="xsType.c"/>
